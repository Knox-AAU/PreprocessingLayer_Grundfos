...
class Scraper:
    ...
    PATH_TO_INVALID_LINKS = (
        os.path.join(os.path.abspath(os.curdir), "scraperdata") + "/invalid_links.txt"
    )
    PATH_TO_VALID_LINKS = (
        os.path.join(os.path.abspath(os.curdir), "scraperdata")
        + "/downloadable_links.txt"
    )
    PATH_TO_INDEXES_CHECKED = (
        os.path.join(os.path.abspath(os.curdir), "scraperdata") + "/checked_links.txt"
    )
